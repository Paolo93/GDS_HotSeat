...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject unitsImg, unitsImg2;
    ...
    public void UpdateStatsPanelLeft()
    {
        ...
        if (activeUnit)
        {
            ...
            unitsImg.GetComponent<SpriteRenderer>().sprite = activeUnit.imageUnit;
    ...
    public void UpdateStatsPanelRight()
    {
        ...
        if (activeUnit)
        {
            ...
            unitsImg2.GetComponent<SpriteRenderer>().sprite = activeUnit.imageUnit;
